---
description: "Get started with Datashelter in minutes. Create an account, add your first server, configure Snaper, and set up automatic backups to your S3 storage."
---
