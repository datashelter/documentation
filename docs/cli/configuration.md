---
description: "Complete reference for Snaper configuration: logging, compression, S3 buckets, encryption, workers, database backups, and file include/exclude rules."
---
